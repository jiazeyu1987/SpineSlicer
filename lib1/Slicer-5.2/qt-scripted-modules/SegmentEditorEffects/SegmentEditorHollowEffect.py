...
class SegmentEditorHollowEffect(AbstractScriptedSegmentEditorEffect):
    ...
    def setupOptionsFrame(self):
        ...
        self.insideSurfaceOptionRadioButton = qt.QRadioButton("在表面内部")
        self.medialSurfaceOptionRadioButton = qt.QRadioButton("在表面中间")
        self.outsideSurfaceOptionRadioButton = qt.QRadioButton("在表面外部")
        ...
        self.scriptedEffect.addLabeledOptionsWidget("使用当前层当作:", operationLayout)
        ...
        self.shellThicknessMMLabel = self.scriptedEffect.addLabeledOptionsWidget("厚度:", shellThicknessFrame)
        ...
        self.applyToAllVisibleSegmentsLabel = self.scriptedEffect.addLabeledOptionsWidget("应用到可见层:", self.applyToAllVisibleSegmentsCheckBox)
