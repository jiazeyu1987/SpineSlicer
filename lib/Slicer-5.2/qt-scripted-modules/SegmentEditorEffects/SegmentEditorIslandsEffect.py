...
about each operation, hover the mouse over the option and wait for the tooltip to appear.</html>"""
    ...
    def setupOptionsFrame(self):
        ...
        self.keepLargestOptionRadioButton = qt.QRadioButton("保留最大岛")
        ...
        self.keepSelectedOptionRadioButton = qt.QRadioButton("保留选择的岛")
        ...
        self.removeSmallOptionRadioButton = qt.QRadioButton("删除最小岛")
        ...
        self.removeSelectedOptionRadioButton = qt.QRadioButton("删除选择的岛")
        ...
        self.addSelectedOptionRadioButton = qt.QRadioButton("添加选择的岛")
        ...
        self.splitAllOptionRadioButton = qt.QRadioButton("拆分岛")
