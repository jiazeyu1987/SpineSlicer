...
"""
    ...
    def initializeDICOMDatabase(self):
        ...
        print("whm test initializeDICOMDatabase", databaseDirectory)
...
class DICOMFileDialog:
    ...
    def dropEvent(self):
        ...
        util.send_event_str(util.DataDropedEvent,",".join(self.directoriesToAdd))
...
class DICOMWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        import slicer.util as util
        if util.get_from_PAAA("current_project_selector_project_name") == "PMedVistaPlanner":
            self.ui.browserSettingsFrame.setVisible(False)
            self.ui.dicomPluginsFrame.setVisible(False)
            self.ui.loadedDataLabel.setVisible(False)
            self.ui.networkingFrame.setVisible(False)
            self.ui.subjectHierarchyTree.setVisible(False)
