...
If segments overlap, segment higher in the segments table will have priority. <b>Applied to all visible segments.</b></li>
    ...
    def setupOptionsFrame(self):
        ...
        self.scriptedEffect.addLabeledOptionsWidget("光滑方式:", self.methodSelectorComboBox)
        ...
        self.kernelSizeMMLabel = self.scriptedEffect.addLabeledOptionsWidget("内核大小:", kernelSizeFrame)
        ...
        self.paintOptionsGroupBox.setTitle("光滑工具选项")
